        ...
        {coreServices.map((service) => {
          ...
          return (
            <Link
              key={service.id}
              href={service.href}
              className="group flex flex-col items-center gap-3 rounded-2xl border border-border bg-white px-3 py-6 text-center transition-all hover:-translate-y-0.5 hover:border-brand-blue-200"
            >
