...
export function StatsBannerSection() {
  ...
  return (
    <section ref={ref} className="bg-brand-blue-900 py-8">
      ...
      */}
      <div className="mx-auto grid w-fit max-w-7xl grid-cols-2 px-4 sm:flex sm:w-auto sm:flex-wrap sm:items-center sm:justify-center sm:gap-y-6 sm:px-6 lg:px-8">
        {stats.map((stat, i) => (
          <div
            key={stat.id}
            className={cn(
