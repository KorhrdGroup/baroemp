...
export function HeroIllustration() {
  return (
    <div className="relative mx-auto aspect-[3/2] w-full max-w-2xl select-none">
      ...
      <div className="absolute left-1 top-4 flex items-center gap-2 rounded-xl bg-white px-4 py-3 shadow-[0_0_22px_-10px_rgba(36,105,255,0.45)] sm:-left-3 sm:top-6">
      ...
      <div className="absolute -right-1 top-20 flex items-center gap-2 rounded-xl bg-white px-4 py-3 shadow-[0_0_22px_-10px_rgba(36,105,255,0.45)] sm:-right-3 sm:top-24">
      ...
      <div className="absolute bottom-4 left-3 flex items-center gap-2 rounded-xl bg-white px-4 py-3 shadow-[0_0_22px_-10px_rgba(36,105,255,0.45)] sm:bottom-2 sm:-left-3">
