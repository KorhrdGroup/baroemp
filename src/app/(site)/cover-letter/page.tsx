...
export default async function CoverLetterListPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8">
        <p className="text-sm font-semibold text-brand-blue-600">자기소개서</p>
        <h1 className="mt-1 text-2xl font-bold text-slate-900 sm:text-3xl">나만의 자기소개서를 작성해보세요.</h1>
        <p className="mt-2 text-[15px] text-slate-500">문항을 자유롭게 추가/삭제/순서변경하고, AI 초안/첨삭을 받아보세요.</p>
      </div>
